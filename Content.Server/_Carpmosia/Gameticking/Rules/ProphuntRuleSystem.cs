...
/// <summary>
/// Manages <see cref="ProphuntRuleComponent"/>
/// </summary>
public sealed class ProphuntRuleSystem : GameRuleSystem<ProphuntRuleComponent>
{
    ...
    private void OnBeforeSpawn(PlayerBeforeSpawnEvent ev)
    {
        ...
        while (query.MoveNext(out var uid, out var ph, out var tracker, out var point, out var rule))
        {
